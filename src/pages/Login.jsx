    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {/* Google Sign-In Button - Only works with HTTPS or localhost */}
          ...
          window.location.hostname === "localhost" ? (
            ...
            <div className="w-full flex flex-col items-center gap-2 px-4 py-3 border border-gray-200 rounded-lg bg-gray-50">
              ...
              <p className="text-xs text-gray-400 text-center">
                Requires HTTPS. Use email/password to sign in.
              </p>
            </div>
          )}
