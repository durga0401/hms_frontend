    ...
    <div className="h-screen w-64 bg-white border-r border-gray-100 fixed left-0 top-0 z-40 flex flex-col shadow-xl">
      ...
      <div className="p-6 bg-gradient-to-r from-primary-600 to-primary-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-primary-100 font-medium">Admin Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-100 bg-gray-50/50">
        <button
          ...
          className="group flex items-center justify-center space-x-2 px-4 py-3 w-full rounded-xl text-gray-600 border-2 border-gray-200 hover:border-primary-300 hover:bg-primary-50 hover:text-primary-600 transition-all duration-200"
        >
          <svg
